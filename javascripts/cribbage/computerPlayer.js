var ComputerPlayer = function () {
  this.SelectTwoCardsToDiscardInCrib = function (
    skillLevel,
    isComputersCrib,
    computersHand
  ) {
  ...
  this.FindOptimalCribDiscards = function (cards, isCribScorePositive) {
    ...
    for (var i = 0; i < cards.length; i++) {
      for (var j = i + 1; j < cards.length; j++) {
        ...
        var scoreStats = this.GetScoreStatsForPossibleDiscards(
          trialCards,
          cribCards,
          isCribScorePositive
        );
  ...
  this.SelectNextCardForPegging = function (
    skillLevel,
    computersHand,
    currentPeggingCount,
    currentPeggingCards,
  ...
  this.FindOptimalPeggingCard = function (
    computersHand,
    currentPeggingCount,
    currentPeggingCards,
    deadPeggingCards,
  ...
  this.GetScoreForCards = function (cards, topCard, isCrib) {
    ...
    for (var i = 0; i < subsets.length; i++) {
      totalPoints =
        totalPoints + GetPairsAndFifteensPointsForSubset(subsets[i]);
    }
