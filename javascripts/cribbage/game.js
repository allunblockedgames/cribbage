var Game = function () {
  ...
  var GAME_OVER_POINTS = 120;
  var SKUNK_POINTS = 91;
  var currentComputerCardSpacing;
  let windowInnerWidth = document.getElementById("game-area").offsetWidth;

  // private variables
  var cardsAreVisible = false;
  var skillLevel = "";
  // Used to keep track of where we are at in the game
  ...
  var cards = [
    {
      ...
      value: 1,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_1.png')",
    },
    {
      id: "2S",
      rank: 2,
      value: 2,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_2.png')",
    },
    {
      id: "3S",
      rank: 3,
      value: 3,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_3.png')",
    },
    {
      id: "4S",
      rank: 4,
      value: 4,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_4.png')",
    },
    {
      id: "5S",
      rank: 5,
      value: 5,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_5.png')",
    },
    {
      id: "6S",
      rank: 6,
      value: 6,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_6.png')",
    },
    {
      id: "7S",
      rank: 7,
      value: 7,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_7.png')",
    },
    {
      id: "8S",
      rank: 8,
      value: 8,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_8.png')",
    },
    {
      id: "9S",
      rank: 9,
      value: 9,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_9.png')",
    },
    {
      id: "TS",
      rank: 10,
      value: 10,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_10.png')",
    },
    {
      id: "JS",
      rank: 11,
      value: 10,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_11.png')",
    },
    {
      id: "QS",
      rank: 12,
      value: 10,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_12.png')",
    },
    {
      id: "KS",
      rank: 13,
      value: 10,
      suit: "S",
      image: "url('images/hearts-classic-1/spade_13.png')",
    },
    {
      id: "AD",
      rank: 1,
      value: 1,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_1.png')",
    },
    {
      id: "2D",
      rank: 2,
      value: 2,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_2.png')",
    },
    {
      id: "3D",
      rank: 3,
      value: 3,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_3.png')",
    },
    {
      id: "4D",
      rank: 4,
      value: 4,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_4.png')",
    },
    {
      id: "5D",
      rank: 5,
      value: 5,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_5.png')",
    },
    {
      id: "6D",
      rank: 6,
      value: 6,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_6.png')",
    },
    {
      id: "7D",
      rank: 7,
      value: 7,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_7.png')",
    },
    {
      id: "8D",
      rank: 8,
      value: 8,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_8.png')",
    },
    {
      id: "9D",
      rank: 9,
      value: 9,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_9.png')",
    },
    {
      id: "TD",
      rank: 10,
      value: 10,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_10.png')",
    },
    {
      id: "JD",
      rank: 11,
      value: 10,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_11.png')",
    },
    {
      id: "QD",
      rank: 12,
      value: 10,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_12.png')",
    },
    {
      id: "KD",
      rank: 13,
      value: 10,
      suit: "D",
      image: "url('images/hearts-classic-1/diamond_13.png')",
    },
    {
      id: "AC",
      rank: 1,
      value: 1,
      suit: "C",
      image: "url('images/hearts-classic-1/club_1.png')",
    },
    {
      id: "2C",
      rank: 2,
      value: 2,
      suit: "C",
      image: "url('images/hearts-classic-1/club_2.png')",
    },
    {
      id: "3C",
      rank: 3,
      value: 3,
      suit: "C",
      image: "url('images/hearts-classic-1/club_3.png')",
    },
    {
      id: "4C",
      rank: 4,
      value: 4,
      suit: "C",
      image: "url('images/hearts-classic-1/club_4.png')",
    },
    {
      id: "5C",
      rank: 5,
      value: 5,
      suit: "C",
      image: "url('images/hearts-classic-1/club_5.png')",
    },
    {
      id: "6C",
      rank: 6,
      value: 6,
      suit: "C",
      image: "url('images/hearts-classic-1/club_6.png')",
    },
    {
      id: "7C",
      rank: 7,
      value: 7,
      suit: "C",
      image: "url('images/hearts-classic-1/club_7.png')",
    },
    {
      id: "8C",
      rank: 8,
      value: 8,
      suit: "C",
      image: "url('images/hearts-classic-1/club_8.png')",
    },
    {
      id: "9C",
      rank: 9,
      value: 9,
      suit: "C",
      image: "url('images/hearts-classic-1/club_9.png')",
    },
    {
      id: "TC",
      rank: 10,
      value: 10,
      suit: "C",
      image: "url('images/hearts-classic-1/club_10.png')",
    },
    {
      id: "JC",
      rank: 11,
      value: 10,
      suit: "C",
      image: "url('images/hearts-classic-1/club_11.png')",
    },
    {
      id: "QC",
      rank: 12,
      value: 10,
      suit: "C",
      image: "url('images/hearts-classic-1/club_12.png')",
    },
    {
      id: "KC",
      rank: 13,
      value: 10,
      suit: "C",
      image: "url('images/hearts-classic-1/club_13.png')",
    },
    {
      id: "AH",
      rank: 1,
      value: 1,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_1.png')",
    },
    {
      id: "2H",
      rank: 2,
      value: 2,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_2.png')",
    },
    {
      id: "3H",
      rank: 3,
      value: 3,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_3.png')",
    },
    {
      id: "4H",
      rank: 4,
      value: 4,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_4.png')",
    },
    {
      id: "5H",
      rank: 5,
      value: 5,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_5.png')",
    },
    {
      id: "6H",
      rank: 6,
      value: 6,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_6.png')",
    },
    {
      id: "7H",
      rank: 7,
      value: 7,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_7.png')",
    },
    {
      id: "8H",
      rank: 8,
      value: 8,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_8.png')",
    },
    {
      id: "9H",
      rank: 9,
      value: 9,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_9.png')",
    },
    {
      id: "TH",
      rank: 10,
      value: 10,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_10.png')",
    },
    {
      id: "JH",
      rank: 11,
      value: 10,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_11.png')",
    },
    {
      id: "QH",
      rank: 12,
      value: 10,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_12.png')",
    },
    {
      id: "KH",
      rank: 13,
      value: 10,
      suit: "H",
      image: "url('images/hearts-classic-1/heart_13.png')",
    },
  ];
  ...
  var cardBackURI = "url('images/hearts-classic-1/back_red.png";
  ...
  for (var i = 0; i < cards.length; i++) {
    ...
    newCard.getElementsByClassName("cardBack")[0].style.backgroundImage =
      cardBackURI;
    newCard.getElementsByClassName("cardFront")[0].style.backgroundImage =
      card.image;
  ...
  this.GetScoreStatsForPossibleDiscards = function (
    trialCards,
    cribCards,
    isCribScorePositive
  ) {
    return computerPlayer.GetScoreStatsForPossibleDiscards(
      trialCards,
      cribCards,
      isCribScorePositive
    );
  ...
  function isGameOver() {
    return playerScore > GAME_OVER_POINTS || computerScore > GAME_OVER_POINTS;
  }

  function isPlayerWon() {
    return playerScore > GAME_OVER_POINTS;
  }

  function isSkunkGame() {
    if (isPlayerWon()) {
      return computerScore < SKUNK_POINTS;
    } else {
      return playerScore < SKUNK_POINTS;
    }
  }
  ...
  function elementDrag(e) {
    ...
    currentDraggedCardView.style.top =
      currentDraggedCardView.offsetTop - pos2 + "px";
    currentDraggedCardView.style.left =
      currentDraggedCardView.offsetLeft - pos1 + "px";
    ...
    setTimeout(function () {
      ...
      if (isIE) {
        cardFront.style.transform =
          "translate3d(0px,0px,1px) perspective(500px) rotateY(0deg)";
        cardBack.style.transform =
          "translate3d(0px,0px,-1px) perspective(500px) rotateY(-180deg)";
        cardShadow.style.transform =
          "translate3d(20px,20px,0px) perspective(500px) rotateY(0deg)";
      } else {
  ...
  function flipUpCard(cardView) {
    ...
    if (isIE) {
      ...
      setTimeout(function () {
        ...
        cardShadow.style.transform =
          "translate3d(0px,0px,0px) perspective(500px) rotateY(0deg)";
      }, 400);
    } else {
      flipContainer.style.transform = "perspective(500px) rotateY(180deg)";
      cardShadow.style.transform = "translate3d(-20px,20px,0px)";
  ...
  function flipDownCard(cardView) {
    ...
    if (isIE) {
      ...
      cardBack.style.transform =
        "translate3d(0px,0px,1px) perspective(500px) rotateY(0deg)";
      cardShadow.style.transform =
        "translate3d(20px,20px,0px) perspective(500px) rotateY(180deg)";
      setTimeout(function () {
        raiseContainer.style.transform = "scale(1)";
        cardShadow.style.transform =
          "translate3d(0px,0px,0px) perspective(500px) rotateY(180deg)";
      }, 400);
    } else {
  ...
  function AnimateScoreBubble(
    ...
    setTimeout(function () {
      ...
      scoreBubble.getElementsByClassName(
        "BubbleScoreDescription"
      )[0].innerText = description + " for";
      scoreBubble.getElementsByClassName("BubbleScorePoints")[0].innerText =
        points;
      var pointsLabel = scoreBubble.getElementsByClassName(
  ...
  function GetDeckCardPosition() {
    if (scoreboard.IsCompactLayout()) {
      return [windowInnerWidth * 0.15, 200];
    } else {
      return [windowInnerWidth * 0.15, 315];
    }
  }

  function GetLeftLowCardPosition() {
    return [windowInnerWidth * 0.5 - 110, GetDeckCardPosition()[1]];
  }
  ...
  function GetDiscardRegionPosition() {
    return [windowInnerWidth * 0.5, GetDeckCardPosition()[1]];
  }
  ...
  function GetPeggingPromptPosition() {
    ...
    var left =
      nextCardPosition[0] + currentPeggingCards.length * peggingCardsOverlap;
    if (currentPeggingCards.length > 0) {
      left = left + 120;
    }
    if (left + 100 > windowInnerWidth) {
      return [
        nextCardPosition[0] +
          currentPeggingCards.length * peggingCardsOverlap +
          40,
        nextCardPosition[1] + cardLoweredHeight * 0.5 + 35,
      ];
    } else {
  ...
  function GetPeggingDeadPileFirstCardLeftPosition() {
    var left = windowInnerWidth * 0.75;
    var peggingSpaceLeft =
      GetPeggingFirstCardPosition()[0] +
      8 * peggingCardsOverlap +
      cardLoweredWidth * 0.5;
    if (left < peggingSpaceLeft) {
      left = windowInnerWidth - cardLoweredWidth * 0.22;
    }
    return left;
  }
  ...
  function GetHandCardPosition(isPlayersCard, isPreCrib, cardIndex) {
    if (isPlayersCard) {
      ...
      var left =
        (windowInnerWidth -
          cardLoweredWidth * cardCount -
          handCardsMaxSpacing * (cardCount - 1)) *
        0.5;
      if (left < 0) {
        // We will have to overlap
        var overlapSpacing = windowInnerWidth / cardCount - cardLoweredWidth;
      ...
      return [
        left + cardLoweredWidth * 0.5,
        GetDeckCardPosition()[1] + cardLoweredHeight + 60,
      ];
    } else {
      var cardCount = 4;
      if (isPreCrib) {
      ...
      var left =
        (windowInnerWidth -
          cardLoweredWidth * cardCount -
          computerCardsMaxSpacing * (cardCount - 1)) *
        0.5;
      var leftMin = 200;
      ...
      if (left < leftMin) {
        // We will have to overlap
        var overlapSpacing =
          (windowInnerWidth - leftMin - rightMin) / cardCount -
          cardLoweredWidth;
      ...
      return [
        left + cardLoweredWidth * 0.5,
        GetDeckCardPosition()[1] - cardLoweredHeight - 20,
      ];
    }
  }
  ...
  function GetCardIndexFromPosition(isPreCrib, cardView) {
    ...
    var index = Math.round(
      (cardView.offsetLeft - handLeft) /
        (cardLoweredWidth + currentPlayerHandCardSpacing)
    );
    if (isPreCrib) {
      if (index < 0) index = 0;
      if (index > 5) index = 5;
  ...
  function GetHandScoreViewPosition(isPlayersPoints) {
    if (isPlayersPoints) {
      if (scoreboard.IsCompactLayout()) {
        return [windowInnerWidth * 0.5 - 100, 50];
      } else {
        return [windowInnerWidth * 0.5 - 100, window.innerHeight * 0.2];
      }
    } else {
      return [windowInnerWidth * 0.5 - 100, window.innerHeight * 0.3];
    }
  }

  function GetManualCountViewPosition() {
    if (scoreboard.IsCompactLayout()) {
      return [windowInnerWidth * 0.5 - 100, 10];
    } else {
      return [windowInnerWidth * 0.5 - 100, 100];
    }
  }
  ...
  function GetRecountButtonPosition(isPlayersPoints) {
    ...
    if (isPlayersPoints) {
      if (scoreboard.IsCompactLayout()) {
        return [windowInnerWidth * 0.5 + 120, deckPos[1] + 70];
      } else {
        return [windowInnerWidth * 0.5 + 120, deckPos[1]];
      }
    } else {
      return [windowInnerWidth * 0.5 + 120, deckPos[1] + 70];
    }
  ...
  function GetHintButtonPosition() {
    ...
    if (checkTop + 25 > window.innerHeight - 90) {
      ...
      return [windowInnerWidth * 0.5 - 35, checkTop];
    }
  }
  ...
  Game.GetPeggingPointsForCards = function (peggingCards) {
    ...
    if (
      curIdx > 0 &&
      peggingCards[curIdx].rank === peggingCards[curIdx - 1].rank
    ) {
      if (
        curIdx > 1 &&
        peggingCards[curIdx].rank === peggingCards[curIdx - 2].rank
      ) {
        if (
          curIdx > 2 &&
          peggingCards[curIdx].rank === peggingCards[curIdx - 3].rank
        ) {
          var scoringPoints = {};
    ...
    for (var runLength = peggingCards.length; runLength >= 3; runLength--) {
      var trailingCards = peggingCards.slice(
        peggingCards.length - runLength,
        peggingCards.length
      );
      ...
      if (point.description === "4 of a kind") {
        for (var j = 0; j < points.length; j++) {
          if (points[j].description === "Pair") {
            if (
              point.cards.indexOf(points[j].cards[0]) !== -1 &&
  ...
  function AnimateSelectLowestCard() {
    ...
    setTimeout(function () {
      ...
      var pos = GetDeckCardPosition();
      visibleLowCardOptionsCount = Math.floor(
        (windowInnerWidth - pos[0] - 144) / cardSpacing
      );
      ...
      for (var i = 0; i < cards.length; i++) {
        ...
        cardView.positionLeftFunction =
          "GetDeckCardPosition()[0] + " + cnt + "*25 + 'px'";
      ...
      setTimeout(function () {
        var selectCardMessage = document.getElementById(
          "select_low_card_message"
        );
        selectCardMessage.positionTopFunction =
          "GetDeckCardPosition()[1] + 140 + 'px'";
        selectCardMessage.positionLeftFunction = "'0px'";
        selectCardMessage.style.top = eval(
          selectCardMessage.positionTopFunction
        );
        selectCardMessage.style.left = eval(
          selectCardMessage.positionLeftFunction
        );
  ...
  function animateComputerSelectingLowCard() {
    ...
    setTimeout(function () {
      selectCardMessage.style.visibility = "hidden";
    }, 600);
    ...
    while (!suitableCardFound) {
      ...
      if (computerSelectedCard.rank != playerSelectedLowCardView.card.rank) {
        ...
        isPlayersCrib =
          playerSelectedLowCardView.card.rank < computerSelectedCard.rank;
  ...
  function ShowLowCardResult() {
    if (
      playerSelectedLowCardView.positionIndex <
      computerSelectedLowCardView.positionIndex
    ) {
      playerSelectedLowCardView.positionLeftFunction =
        "GetLeftLowCardPosition()[0] + 'px'";
      playerSelectedLowCardView.style.transition = "1s ease-in-out";
      playerSelectedLowCardView.style.left = eval(
        playerSelectedLowCardView.positionLeftFunction
      );

      computerSelectedLowCardView.positionLeftFunction =
        "GetRightLowCardPosition()[0] + 'px'";
      computerSelectedLowCardView.style.transition = "1s ease-in-out";
      computerSelectedLowCardView.style.left = eval(
        computerSelectedLowCardView.positionLeftFunction
      );
    } else {
      computerSelectedLowCardView.positionLeftFunction =
    ...
    var playerCardIsOnLeft =
      playerSelectedLowCardView.positionIndex <
      computerSelectedLowCardView.positionIndex;
    var youText = document.getElementById("low_card_you_text");
    youText.positionLeftFunction = playerCardIsOnLeft
      ? "GetLeftLowCardPosition()[0] + 'px'"
      : "GetRightLowCardPosition()[0] + 'px'";
    ...
    oppText.positionLeftFunction = playerCardIsOnLeft
      ? "GetRightLowCardPosition()[0] + 'px'"
      : "GetLeftLowCardPosition()[0] + 'px'";
    ...
    setTimeout(function () {
      ...
      if (isPlayersCrib) {
        resultText.innerHTML =
          "You drew the lower card!<br>You get the first crib.";
      } else {
        resultText.innerHTML =
          "Opponent drew the lower card.<br>They get the first crib.";
      }
      var resultMessage = document.getElementById("low_card_result_message");
      resultMessage.positionTopFunction =
        "GetDeckCardPosition()[1] + 110 + 'px'";
    ...
    setTimeout(function () {
      ...
      for (var i = 0; i < cards.length; i++) {
        if (
          cards[i].id == computerSelectedLowCardView.card.id ||
          cards[i].id == playerSelectedLowCardView.card.id
        ) {
          continue;
        }
        var cardView = cards[i].cardView;
  ...
  this.lowCardAcceptClick = function lowCardAcceptClick() {
    ...
    playerSelectedLowCardView.positionLeftFunction =
      "GetDeckCardPosition()[0] + 'px'";
    playerSelectedLowCardView.positionTopFunction =
      "GetDeckCardPosition()[1] + 'px'";
    ...
    computerSelectedLowCardView.positionLeftFunction =
      "GetDeckCardPosition()[0] + 'px'";
    computerSelectedLowCardView.positionTopFunction =
      "GetDeckCardPosition()[1] + 'px'";
  ...
  function AnimateDealingHands() {
    ...
    setTimeout(function () {
      for (var i = 0; i < 6; i++) {
        var cardView = playersHand[i].cardView;
        cardView.positionLeftFunction =
          "GetHandCardPosition(true, true, " + i + ")[0] + 'px'";
        cardView.positionTopFunction =
          "GetHandCardPosition(true, true, " + i + ")[1] + 'px'";
        cardView.positionIndex = i;
    ...
    for (var i = 0; i < 6; i++) {
      ...
      cardView.positionLeftFunction =
        "GetHandCardPosition(false, true, " + i + ")[0] + 'px'";
      cardView.positionTopFunction =
        "GetHandCardPosition(false, true, " + i + ")[1] + 'px'";
      cardView.positionIndex = i;
      with (cardView.style) {
        transition = "0.5s ease-out";
        transitionDelay = i * 150 + "ms";
  ...
  function preCribCardPointerPressed(cardView) {
    ...
    autoPlayBoundaryY =
      GetHandCardPosition(true, true, currentDraggedCardView.positionIndex)[1] -
      cardLoweredHeight * 0.4;
    ...
    if (cribPositionIndex > -1) {
      ...
      if (crib.length == 1) {
        ...
        remainingCardView.positionLeftFunction =
          "GetDiscardRegionPosition()[0] - " + cribDiscardSpacing + " + 'px'";
        remainingCardView.positionTopFunction =
          "GetDiscardRegionPosition()[1] + 'px'";
    ...
    if (currentDraggedCardView.offsetTop > autoPlayBoundaryY) {
      ...
      if (curIndex != currentDraggedCardView.positionIndex) {
        ...
        while (displacedCard != null) {
          if (incrementing) {
            var tempCard =
              playersHand[displacedCard.cardView.positionIndex + 1];
            displacedCard.cardView.positionIndex =
              displacedCard.cardView.positionIndex + 1;
            playersHand[displacedCard.cardView.positionIndex] = displacedCard;
            if (currentPlayerHandCardSpacing < 0) {
              if (firstDisplacement) {
                slideCardToHandPositionWithOverlap(
                  true,
                  incrementing,
                  displacedCard.cardView,
                  curIndex
                );
              } else {
  ...
  function preCribCardPointerFinished() {
    ...
    if (currentPreCribDraggedCardWasLastInTheCrib) {
      if (
        tapped ||
        currentDraggedCardView.offsetTop >
          GetDeckCardPosition()[1] + cardLoweredHeight * 0.4
      ) {
  ...
  function returnCardViewToHandPosition(isPreCrib, cardView) {
    cardView.positionLeftFunction =
      "GetHandCardPosition(true, " +
      isPreCrib +
      ", " +
      cardView.positionIndex +
      ")[0] + 'px'";
    cardView.positionTopFunction =
      "GetHandCardPosition(true, " +
      isPreCrib +
  ...
  function slideCardToHandPositionWithOverlap(
    isPreCrib,
    isIncrementing,
    cardView,
    curIndex
    ...
    with (cardView.style) {
      ...
      left = isIncrementing
        ? cardView.offsetLeft + cardLoweredWidth * 1.5 + "px"
        : cardView.offsetLeft + cardLoweredWidth * 1.0 + "px";
      zIndex = isIncrementing
        ? cardView.positionIndex + 100 - 1
        : cardView.positionIndex + 100 - 1;
    }
    setTimeout(function () {
  ...
  /**
   * Places a user selected card into the crib
   * @param {*} cardView
   * @returns
   */
  function dropCardViewInCrib(cardView) {
    ...
    cardView.positionLeftFunction =
      "GetDiscardRegionPosition()[0] + " + leftOffset + " + 'px'";
    ...
    if (crib.length == 2) {
      ...
      var confirmCribRegion = document.getElementById("confirm_crib_region");
      confirmCribRegion.positionLeftFunction =
        "GetCribConfirmRegionPosition()[0] + 'px'";
      confirmCribRegion.positionTopFunction =
        "GetCribConfirmRegionPosition()[1] + 'px'";
      confirmCribRegion.style.transition = "none";
      confirmCribRegion.style.left = eval(
        confirmCribRegion.positionLeftFunction
      );
  ...
  this.cribCardsConfirmed = function () {
    if (
      ...
      var scoreStats = computerPlayer.GetScoreStatsForPossibleDiscards(
        trialCards,
        crib,
        isPlayersCrib
      );
      var optimalStats = computerPlayer.FindOptimalCribDiscards(
        allCards,
        isPlayersCrib
      );
  ...
  function ShowSuboptimalWarning(suboptimalPlay) {
    ...
    var suboptimalWarningTitle = document.getElementById(
      "SuboptimalWarningTitle"
    );
    var suboptimalWarningText = document.getElementById(
      "SuboptimalWarningText"
    );
    var suboptimalShowAllButton = document.getElementById(
      "SuboptimalWarningShowAllScoresButton"
    );
    var suboptimalPlayAnywaysButton = document.getElementById(
      "SuboptimalWarningPlayAnywaysButton"
    );
    if (suboptimalPlay.isDiscard) {
      ...
      suboptimalWarningText.innerHTML =
        "Your discards will result in an average round score of " +
        parseFloat(suboptimalPlay.playedScore).toFixed(1) +
        "<br><br>A better play exists that would result in an average score of " +
        parseFloat(suboptimalPlay.optimalScore).toFixed(1);
    } else {
      ...
      suboptimalWarningText.innerHTML =
        "Your card will result in a score of " +
        suboptimalPlay.playedScore +
        "<br><br>A better play exists that would result in a score of " +
        suboptimalPlay.optimalScore;
    }
  ...
  this.SuboptimalWarningTryAgainClick = function () {
    ...
    if (!currentSuboptimalPlay.isDiscard) {
      returnCardViewToHandPosition(
        false,
        currentSuboptimalPlay.playedCards[0].cardView
      );
    }
  };
  ...
  function AnimateComputerDiscardingToCrib() {
    ...
    var computerDiscards = computerPlayer.SelectTwoCardsToDiscardInCrib(
      skillLevel,
      !isPlayersCrib,
      computersHand
    );
    ...
    for (var i = 0; i < computerDiscards.length; i++) {
      ...
      computerDiscards[i].cardView.positionLeftFunction =
        "GetDiscardRegionPosition()[0] + 'px'";
      computerDiscards[i].cardView.positionTopFunction =
        "GetDiscardRegionPosition()[1] + 'px'";
    ...
    setTimeout(function () {
      ...
      for (var i = 0; i < crib.length; i++) {
        crib[i].cardView.positionLeftFunction =
          "GetCribWaitingPosition()[0] + 'px'";
        crib[i].cardView.positionTopFunction =
          "GetCribWaitingPosition()[1] + 'px'";
    ...
    for (var i = 0; i < playersHand.length; i++) {
      var cardView = playersHand[i].cardView;
      cardView.positionLeftFunction =
        "GetHandCardPosition(true, false, " + i + ")[0] + 'px'";
      cardView.positionTopFunction =
        "GetHandCardPosition(true, false, " + i + ")[1] + 'px'";
      cardView.positionIndex = i;
      with (cardView.style) {
        transition = "0.5s ease-out";
    ...
    for (var i = 0; i < computersHand.length; i++) {
      var cardView = computersHand[i].cardView;
      cardView.positionLeftFunction =
        "GetHandCardPosition(false, false, " + i + ")[0] + 'px'";
      cardView.positionTopFunction =
        "GetHandCardPosition(false, false, " + i + ")[1] + 'px'";
      cardView.positionIndex = i;
      with (cardView.style) {
        transition = "0.5s ease-out";
        transitionDelay = "0.8s";
    ...
    var cribOverlayText = document.getElementById(
      "crib_indicator_card_overlap_text"
    );
  ...
  function InitializePeggingRound() {
    ...
    topCard.cardView.positionLeftFunction =
      "GetDeckCardPosition()[0] + 10 + 'px'";
    ...
    if (topCard.rank == 11) {
      ...
      AnimateScoreBubble(
        [bubblePosition[0] + 10, bubblePosition[1]],
        2,
        "Nibs for",
        isPlayersCrib,
        800
    ...
    peggingCountIndicator.positionLeftFunction =
      "GetDeckCardPosition()[0] - 115*0.5 + 10 + 'px'";
    peggingCountIndicator.positionTopFunction =
      "GetDeckCardPosition()[1] - 75*0.5 + 'px'";
    peggingCountIndicator.style.top = eval(
      peggingCountIndicator.positionTopFunction
    );
    peggingCountIndicator.style.left = eval(
      peggingCountIndicator.positionLeftFunction
    );
  ...
  function peggingCardPointerPressed(cardView) {
    ...
    autoPlayBoundaryY =
      GetHandCardPosition(
        true,
        false,
        currentDraggedCardView.positionIndex
      )[1] -
      cardLoweredHeight * 0.4;
    ...
    if (tapped || currentDraggedCardView.offsetTop < autoPlayBoundaryY) {
      if (isPlayersTurnToPeg) {
        ...
        if (currentDraggedCardView.card.value + currentPeggingCount <= 31) {
          ...
          var optimalStats = computerPlayer.FindOptimalPeggingCard(
            playersHand,
            currentPeggingCount,
            currentPeggingCards,
            deadPeggingCards,
  ...
  function FinishPeggingPlay(cardView) {
    ...
    for (var i = 0; i < peggingPoints.length; i++) {
      ...
      AnimateScoreBubble(
        ...
        scoringPoints.description,
        true,
        i * bubbleScoreVisibleDuration + cardAnimationDelay
      );
    }
    ...
    setTimeout(function () {
      ...
      if (currentPeggingCards.length + deadPeggingCards.length == 8) {
        ...
        if (currentPeggingCount != 31) {
          ...
          finalCardPointDelay =
            finalCardPointDelay + bubbleScoreVisibleDuration;
          var position = GetPeggingFirstCardPosition();
          var left =
            position[0] + currentPeggingCards.length * peggingCardsOverlap;
          var top = position[1];
  ...
  function ShowTheUserToPlayOrSayGo() {
    for (var i = 0; i < playersHand.length; i++) {
      if (
        playersHand[i] !== null &&
        playersHand[i].value + currentPeggingCount <= 31
      ) {
  ...
  function ShowMessageUserMustSayGo() {
    ...
    playerSaysGoMessage.positionLeftFunction =
      "windowInnerWidth*0.5 - 115*0.5 + 'px'";
    playerSaysGoMessage.positionTopFunction =
      "GetHandCardPosition(true, false, 2)[1] - 65*0.5 + 'px'";
    playerSaysGoMessage.style.left = eval(
      playerSaysGoMessage.positionLeftFunction
    );
    playerSaysGoMessage.style.top = eval(
      playerSaysGoMessage.positionTopFunction
    );
  ...
  function ShowMessageThatComputerSaysGo() {
    ...
    computerSaysGoMessage.positionLeftFunction =
      "windowInnerWidth*0.5 - 115*0.5 + 'px'";
    computerSaysGoMessage.positionTopFunction =
      "GetHandCardPosition(false, false, 2)[1] + 15 + 'px'";
    computerSaysGoMessage.style.left = eval(
      computerSaysGoMessage.positionLeftFunction
    );
    computerSaysGoMessage.style.top = eval(
      computerSaysGoMessage.positionTopFunction
    );
  ...
  function PlayNextPeggingCardForComputer() {
    var computerPlay = computerPlayer.SelectNextCardForPegging(
      skillLevel,
      computersHand,
      currentPeggingCount,
      currentPeggingCards,
  ...
  function AnimateCardViewToPeggingPile(cardView, isPlayersCard) {
    ...
    cardView.positionLeftFunction =
      "GetPeggingFirstCardPosition()[0] + (" +
      currentPeggingCards.length +
      ")*peggingCardsOverlap + 'px'";
    if (isPlayersCard) {
      cardView.positionTopFunction =
        "GetPeggingFirstCardPosition()[1] + " +
        peggingCardsVerticalOffset +
        " + 'px'";
    } else {
      cardView.positionTopFunction =
        "GetPeggingFirstCardPosition()[1] - " +
  ...
  function OnResetPeggingCount() {
    ...
    for (var i = 0; i < deadPeggingCards.length; i++) {
      ...
      deadCard.cardView.positionLeftFunction =
        "GetPeggingDeadPileFirstCardLeftPosition() + " +
        i +
        "*peggingDeadCardsOverlap + 'px'";
      deadCard.cardView.style.transition = "0.4s ease-out";
      deadCard.cardView.style.left = eval(
        deadCard.cardView.positionLeftFunction
      );
  ...
  function UpdatePeggingAverageRecord() {
    var computerPeggingPointsThisRound =
      computerScore - recordComputerPeggingStartingScore;
    var playerPeggingPointsThisRound =
      playerScore - recordPlayerPeggingStartingScore;
    computerPeggingPointsTotal =
      computerPeggingPointsTotal + computerPeggingPointsThisRound;
    playerPeggingPointsTotal =
      playerPeggingPointsTotal + playerPeggingPointsThisRound;
  ...
  function AnimateCardsBackForCounting() {
    ...
    playerPlayedPeggingCards.sort(function (a, b) {
      return a.rank - b.rank;
    });
    computerPlayedPeggingCards.sort(function (a, b) {
      return a.rank - b.rank;
    });
  ...
  function InitializeManualCountingOfCards(cards, isCrib) {
    ...
    document.getElementById("ManualPointConfirmButton").style.visibility =
      "hidden";
    document.getElementById("ManualScoreBubblePoints").innerHTML = "0";
    document.getElementById("ManualPointsDesc").innerHTML = "";

    manualScoringPointsAvailable = Game.GetPointsForHand(
      cards,
      topCard,
      isCrib
    );
    ...
    manualCountView.positionLeftFunction =
      "GetManualCountViewPosition()[0] + 'px'";
    manualCountView.positionTopFunction =
      "GetManualCountViewPosition()[1] + 'px'";
  ...
  function AnalyzeSelectedCardsForManualCounting() {
    ...
    for (var i = 0; i < manualScoringPointsAvailable.length; i++) {
      if (
        manualScoringPointsAvailable[i].cards.length === selectedCards.length &&
        !manualScoringPointsAvailable[i].pointsCounted
      ) {
        var matchCount = 0;
        for (var j = 0; j < manualScoringPointsAvailable[i].cards.length; j++) {
          if (
            selectedCards.indexOf(manualScoringPointsAvailable[i].cards[j]) !==
            -1
          ) {
  ...
  this.OnManualCountAcceptClick = function () {
    ...
    if (GetSetting("setting_muggins") && !isGameOver()) {
      ...
      if (mugginsPoints.length > 0) {
        ...
        setTimeout(function () {
          var delay = RegisterAndAnimateHandScores(
            mugginsPoints,
            false,
            isManuallyCountingTheCrib,
            topCard
          );
          setTimeout(function () {
  ...
  function ShowMugginsScoreView(scoringPoints, isPlayersPoints) {
    ...
    var HandScoreBubblePoints = document.getElementById(
      "HandScoreBubblePoints"
    );
    var HandScoreBubblePointsLabel = document.getElementById(
      "HandScoreBubblePointsLabel"
    );
    var HandScorePointsDescription = document.getElementById(
      "HandScorePointsDescription"
    );
    var HandScoreAcceptButton = document.getElementById(
      "HandScoreAcceptButton"
    );

    HandScoreView.style.zIndex = 701;
    HandScoreView.positionLeftFunction =
      "GetHandScoreViewPosition(false)[0] + 'px'";
    HandScoreView.positionTopFunction =
      "GetHandScoreViewPosition(false)[1] + 'px'";
    ...
    HandScoreBubblePointsLabel.innerText =
      scoringPoints == 1 ? "point" : "points";
  ...
  function ShowTotalHandScoreView(scoringPoints, isPlayersPoints, isCrib) {
    ...
    HandScoreView.positionLeftFunction =
      "GetHandScoreViewPosition(" + isPlayersPoints + ")[0] + 'px'";
    HandScoreView.positionTopFunction =
      "GetHandScoreViewPosition(" + isPlayersPoints + ")[1] + 'px'";
    HandScoreView.style.transition = "none all";
    HandScoreView.style.opacity = 0;
    HandScoreView.style.left = eval(HandScoreView.positionLeftFunction);
    HandScoreView.style.top = eval(HandScoreView.positionTopFunction);
  ...
  function GenerateScoreDescriptions(scoringPoints) {
    ...
    for (var i = 0; i < scoringPoints.length; i++) {
      ...
      if (
        scoringPoints[i].descriptionID == 0 ||
        scoringPoints[i].descriptionID == 1 ||
        scoringPoints[i].descriptionID == 4
      ) {
        continue;
      }
      scoreDescriptionHTML =
        scoreDescriptionHTML +
        scoringPoints[i].description +
        " for " +
        scoringPoints[i].points +
        "<br>";
    }
  ...
  function RegisterAndAnimateHandScores(
    points,
    isPlayersPoints,
    isCrib,
    topCard
  ...
  function AnimateManualPoint(point, topCard) {
    ...
    for (var j = 0; j < point.cards.length; j++) {
      ...
      position[0] =
        position[0] + Number(xString.substring(0, xString.length - 2));
      position[1] =
        position[1] + Number(yString.substring(0, yString.length - 2));
    }
    if (includesTopCard) {
  ...
  function CountPointsForComputer() {
    ...
    for (var i = 0; i < computersHand.length; i++) {
      ...
      cardView.positionLeftFunction =
        "GetComputerHandCountingPosition(" + i + ")[0] + 'px'";
      cardView.positionTopFunction =
        "GetComputerHandCountingPosition(" + i + ")[1] + 'px'";
      cardView.style.left = eval(cardView.positionLeftFunction);
      cardView.style.top = eval(cardView.positionTopFunction);
    }
  ...
  function ShowRecountButton() {
    ...
    recountButton.positionLeftFunction =
      "GetRecountButtonPosition(" +
      currentRecountScoringIsPlayersPoints +
      ")[0] + 'px'";
    recountButton.positionTopFunction =
      "GetRecountButtonPosition(" +
      currentRecountScoringIsPlayersPoints +
      ")[1] + 'px'";
  ...
  this.OnRecountButtonClick = function () {
    ...
    setTimeout(function () {
      var delay = AnimateHandScores(
        currentRecountScoringPoints,
        currentRecountScoringIsPlayersPoints,
        currentRecountScoringIsCrib,
        currentRecountScoringTopCard
      );
      setTimeout(function () {
        handScoreView.style.opacity = 1;
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        ...
        for (var i = 0; i < crib.length; i++) {
          ...
          if (isPlayersCrib) {
            cribCardView.positionLeftFunction =
              "GetHandCardPosition(true, false, " + i + ")[0] + 'px'";
            cribCardView.positionTopFunction =
              "GetHandCardPosition(true, false, " + i + ")[1] + 'px'";
          } else {
            cribCardView.positionLeftFunction =
              "GetComputerHandCountingPosition(" + i + ")[0] + 'px'";
  ...
  function ShowNoOptimalPlay() {
    ...
    message.positionLeftFunction = "windowInnerWidth*0.5 - 200*0.5 + 'px'";
    message.positionTopFunction =
      "GetHandCardPosition(true, false, 2)[1] - 100*0.5 + 'px'";
  ...
  function BumpHintCards() {
    ...
    if (currentMoveStage === "WaitingForUserToPlayPeggingCard") {
      var bestMoveInfo = computerPlayer.FindOptimalPeggingCard(
        playersHand,
        currentPeggingCount,
        currentPeggingCards,
        deadPeggingCards,
      ...
      optimalCards = computerPlayer.FindOptimalCribDiscards(
        cards,
        isPlayersCrib
      )[0];
    } else if (currentMoveStage === "WaitingForUserToManuallyCount") {
      ...
      var allCounted = document.getElementById("allcounted");
      allCounted.positionLeftFunction =
        "windowInnerWidth*0.5 - 115*0.5 + 'px'";
      allCounted.positionTopFunction =
        "GetHandCardPosition(true, false, 2)[1] - 65*0.5 + 'px'";
  ...
  function AnimateGameFinished() {
    ...
    if (isPlayerWon()) {
      ...
      var settingVal = GetStatistic(setting);
      SetStatistic(setting, settingVal + 1);
      if (window.cribbageApi && window.cribbageApi.winGame) {
        window.cribbageApi.winGame();
      }
      if (isSkunkGame()) {
      ...
      var settingVal = GetStatistic(setting);
      SetStatistic(setting, settingVal + 1);
      if (window.cribbageApi && window.cribbageApi.loseGame) {
        window.cribbageApi.loseGame();
      }
    }
    ...
    for (var i = 0; i < suboptimalPlays.length; i++) {
      suboptimalErrorTotal =
        suboptimalErrorTotal +
        suboptimalPlays[i].optimalScore -
        suboptimalPlays[i].playedScore;
    }
  ...
  function ShowGameOver() {
    ...
    document.getElementById("GameOverResultText").innerHTML = isPlayerWon()
      ? "You won!"
      : "You lost";
    document.getElementById("GameOverSkunkText").style.display = isSkunkGame()
      ? "block"
      : "none";
    ...
    document.getElementById("GameOverTotalFill").style.width =
      200 * percent + "px";

    document.getElementById("GameOverPeggingYou").innerText =
      playerPeggingPointsTotal;
    document.getElementById("GameOverPeggingOpp").innerText =
      computerPeggingPointsTotal;
    percent = 0.5;
    if (playerPeggingPointsTotal + computerPeggingPointsTotal > 0) {
      percent =
        computerPeggingPointsTotal /
        (playerPeggingPointsTotal + computerPeggingPointsTotal);
    }
    document.getElementById("GameOverPeggingFill").style.width =
      200 * percent + "px";

    document.getElementById("GameOverHandsYou").innerText =
      playerHandPointsTotal;
    document.getElementById("GameOverHandsOpp").innerText =
      computerHandPointsTotal;
    percent = 0.5;
    if (playerHandPointsTotal + computerHandPointsTotal > 0) {
      percent =
        computerHandPointsTotal /
        (playerHandPointsTotal + computerHandPointsTotal);
    }
    document.getElementById("GameOverHandsFill").style.width =
      200 * percent + "px";

    document.getElementById("GameOverCribsYou").innerText =
      playerCribPointsTotal;
    document.getElementById("GameOverCribsOpp").innerText =
      computerCribPointsTotal;
    percent = 0.5;
    if (playerCribPointsTotal + computerCribPointsTotal > 0) {
      percent =
        computerCribPointsTotal /
        (playerCribPointsTotal + computerCribPointsTotal);
    }
    document.getElementById("GameOverCribsFill").style.width =
      200 * percent + "px";
    ...
    setTimeout(function () {
      gameOverView.style.transition =
        "1s cubic-bezier(0.175, 0.885, 0.320, 1.275)";
  ...
  function setGameSize() {
    ...
    const scaleValue = Math.min(1, Math.max(0.55, window.innerWidth / 1200));
    $game.style.transform = `scale(${scaleValue})`;
    $game.style["transform-origin"] = "50px 150px";
  }
